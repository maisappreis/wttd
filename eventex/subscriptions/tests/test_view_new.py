...
class SubscriptionsNewGet(TestCase):
    def setUp(self):
        self.response = self.client.get(r('subscriptions:new')) # url do GET '/inscricao/'
...
class TemplateRegressionTest(TestCase):
    def test_template_has_no_fields_error(self):
        invalid_data = dict(name='Henrique Bastos', cpf='78945612320')
